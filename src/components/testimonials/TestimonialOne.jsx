                    ...
                    <motion.div className="flex">
                        {testimonials.map((item, index) => (
                            <motion.div
                                ...
                                whileInView="visible"
                                viewport={{ once: true }}
                                className="relative flex-full px-3"
                                key={item.id}
                            >
                                <div className="p-[60px] bg-black-900 rounded-3xl text-white">
                                    <p className="text-2xl leading-[160%]">
                                        {item?.description}
                                    </p>
                                    <div className="flex items-center justify-between mt-[60px]">
                                        <div className="flex items-center  gap-4">
                                            <div className="relative w-[100px] flex items-end justify-center aspect-square bg-blue-500 rounded-full">
                                                <Image
                                                    src={item.img}
                                                    width={86}
                                                    height={86}
